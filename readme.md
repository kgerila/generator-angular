# AngularJS generator - Youngjun Kim [![Build Status](https://travis-ci.org/kgerila/generator-angular.png?branch=master)](https://travis-ci.org/kgerila/generator-angular) [![Built with Grunt](https://cdn.gruntjs.com/builtwith.png)](http://gruntjs.com/)
